...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class=" text-center">
        <!--<h1>Really Mobile</h1>
        <p>Empresa de Soluciones Moviles</p>-->
        <form>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <img src="gif/imagen-gif-2.0.gif" alt="PLANES POSTPAGO">
                    ...
                    <div class="item">
                        <img src="gif/imagen.0-gif.gif" alt="SMARTPHONES">
                        <div class="carousel-caption">
                            <h3>SMARTPHONES</h3>
                            <p>REALLY MOBILE</p>
                        </div>
                    ...
                    <div class="item">
                        <img src="gif/imagen-gif-3.0.gif" alt="PREPAGO">
                        <div class="carousel-caption">
                            <h3>PREPAGO</h3>
                            <p>REALLY MOBILE</p>
                        </div>
                    ...
                    <div class="item ">
                        <img src="img/imagen-4.0.jpg" alt="PLANES HOGAR"  >
                        <div class="carousel-caption">
                            <h3>PLANES HOGAR</h3>
                            <p>REALLY MOBILE</p>
                        </div>
                    ...
                    <div class="item ">
                        <img src="gif/imagen-gif-4.0.gif" alt="EMPRESAS">
                        <div class="carousel-caption">
                            <h3>EMPRESAS</h3>
                            <p>REALLY MOBILE</p>
                        </div>
                    ...
                    <div class="item ">
                        <img src="gif/imagen-gif-5.gif" alt="Televisi&oacuten">
                        <div class="carousel-caption">
                            <h3>Televisi&oacuten</h3>
                            <p>REALLY MOBILE</p>
                        </div>
                    </div>

                    <div class="item ">
                        <img src="gif/imagen-gif-6.0.gif" alt="CLOUD">
                        <div class="carousel-caption">
                            <h3>CLOUD</h3>
                            <p>REALLY MOBILE</p>
                        </div>
    ...
    <div id="about" class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                <h2>Mision</h2><br>
                <h4>REALLY MOBILE es una empresa que se compromete prestar el mejor servicio de telecomunicaciones, de soluciones moviles para personas naturales y juridicas, siempre caracterizandose por el excelente servicio postventa y la excelencia en el servicio al cliente.</h4><br>
                <h2>Vision</h2><br>
                <h4>Ser la empresa  lider en el mercado colombiano respecto a las telecomunicaciones, servicio al cliente, en las soluciones para el hogar y la empresa con todos los estandares de calidad.</h4><br>
    ...
    <div class="container-fluid bg-grey">
        <div class="row">
            <div class="col-sm-4">
                ...
                <!--<div><img src="img/imagen-5"/></div>-->
            </div>
            <div class="col-sm-8">
                <img src="gif/imagen-9.0.gif" alt="" />
                <br />
                <br />
                <br />
               
                <h4>REALLY MOBILE ofrece los servicios de planes celulares, planes para su hogar y para su empresa. Ofrecemos todo lo necesario para que siempre este conectado con lo que mas quiere. Siempre estaremos a la vanguardia para que su empresa evolucione y ofrezca soluciones a sus clientes. Siempre los respaldaremos con un excelente servicio. Really Mobile es su mejor opcion .</h4><br>
    ...
    <
        ...
        <h2>REALLY MOBILE</h2>
        <div id="#frases" class="carousel slide text-center" data-ride="carousel">
            <!-- Indicators -->
            <!--<ol class="carousel-indicators">
                <li data-target="#myCarousel" data-slide-to="0" class="active"></li>
                <li data-target="#myCarousel" data-slide-to="1"></li>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <h4>"Cuanto mas grande es la prueba, mas glorioso es el triunfo"<br><span> William Shakespeare</span></h4>
                </div>
                <div class="item">
                    <h4>"Todos tus sue&ntildeos se pueden convertir en realidad si tienes el coraje de perseguirlos"<br><span>Walt Disney.</span></h4>
                </div>
                <div class="item">
                    <h4>"Invertir en conocimientos produce siempre los mejores beneficios"<br><span>Benjamin Franklin.</span></h4>
                </div>
            </div>

            <!-- Left and right controls -->
            <!--<a class="left carousel-control" href="#frases" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <!-- Container (Pricing Section) -->
     ...
     <div id="contact" class="container-fluid bg-grey">
        ...
        <div class="row">
            <div class="col-sm-5">
                <p>Contactenos las 24 horas.</p>
                <p><span class="glyphicon glyphicon-map-marker"></span>Bogota , COL</p>
                <p><span class="glyphicon glyphicon-phone"></span>+9003171 - 4146532</p>
                <p><span class="glyphicon glyphicon-envelope"></span> contacto@reallymobile.com.co</p>
            </div>
    ...
    <script>
function myMap() {
var myCenter = new google.maps.LatLng(4.6153759, -74.1346235);
...
marker.setMap(map);
 ...
 <p><a href="https://es-la.facebook.com" ><img src="img/facebook.png" style="width:60px !important;height:60px !important;"/></a><a><img style="width:50px !important;height:45px !important;" src="img/twitter.png"/></a><a><img style="width:70px !important;height:50px !important;" src="img/youtube.png"/></a></p>
        <p>&copy;REALLY MOBILE</p>
    </footer>
